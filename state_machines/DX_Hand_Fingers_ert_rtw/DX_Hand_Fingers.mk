###########################################################################
## Makefile generated for Simulink model 'DX_Hand_Fingers'. 
## 
## Makefile     : DX_Hand_Fingers.mk
## Generated on : Tue Dec 22 18:21:16 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/DX_Hand_Fingers
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Tonno/Google\ Drive/Drive/Leap\ Chords/Leapchord_SenzaTastiera/state_machines
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = DX_Hand_Fingers_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/DX_Hand_Fingers
...
INCLUDES_BUILDINFO = -I$(START_DIR)/DX_Hand_Fingers_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=DX_Hand_Fingers -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/DX_Hand_Fingers_ert_rtw/DX_Hand_Fingers.c

MAIN_SRC = $(START_DIR)/DX_Hand_Fingers_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/DX_Hand_Fingers_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/DX_Hand_Fingers_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
