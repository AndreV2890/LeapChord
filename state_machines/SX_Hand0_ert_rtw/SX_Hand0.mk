###########################################################################
## Makefile generated for Simulink model 'SX_Hand0'. 
## 
## Makefile     : SX_Hand0.mk
## Generated on : Tue Dec 01 11:47:35 2015
## MATLAB Coder version: 2.6 (R2014a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/SX_Hand0
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = /Users/Tonno/Google\ Drive/Drive/LeapChord_DiGuardo_Vincentini/state_machines
ARCH                      = maci64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
MODELREF_LINK_RSPFILE_NAME = SX_Hand0_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/SX_Hand0
...
INCLUDES_BUILDINFO = -I$(START_DIR)/SX_Hand0_ert_rtw -I$(START_DIR) -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert
...
DEFINES_STANDARD = -DMODEL=SX_Hand0 -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DUNIX
...
SRCS = $(START_DIR)/SX_Hand0_ert_rtw/SX_Hand0.c

MAIN_SRC = $(START_DIR)/SX_Hand0_ert_rtw/ert_main.c
...
%.o : $(START_DIR)/SX_Hand0_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.o : $(START_DIR)/SX_Hand0_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
