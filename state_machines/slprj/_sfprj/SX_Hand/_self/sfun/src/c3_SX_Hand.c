...
static void initialize_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void initialize_params_c3_SX_Hand(SFc3_SX_HandInstanceStruct
  *chartInstance);
static void enable_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void disable_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void c3_update_debugger_state_c3_SX_Hand(SFc3_SX_HandInstanceStruct
  *chartInstance);
static const mxArray *get_sim_state_c3_SX_Hand(SFc3_SX_HandInstanceStruct
  *chartInstance);
static void set_sim_state_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_st);
static void c3_set_sim_state_side_effects_c3_SX_Hand(SFc3_SX_HandInstanceStruct *
  chartInstance);
static void finalize_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void sf_gateway_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void initSimStructsc3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void c3_Chord_change_control(SFc3_SX_HandInstanceStruct *chartInstance);
static void c3_enter_atomic_wait_hand(SFc3_SX_HandInstanceStruct *chartInstance);
static void c3_wait_for_change(SFc3_SX_HandInstanceStruct *chartInstance);
static void c3_enter_atomic_filter_state(SFc3_SX_HandInstanceStruct
  *chartInstance);
static void c3_exit_internal_playing_mode(SFc3_SX_HandInstanceStruct
  *chartInstance);
static int32_T c3_abs(SFc3_SX_HandInstanceStruct *chartInstance, int32_T c3_x);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber, uint32_T c3_instanceNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static boolean_T c3_b_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_sf_internal_predicateOutput, const char_T *c3_identifier);
static boolean_T c3_c_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_d_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_b_sfEvent, const char_T *c3_identifier);
static int32_T c3_e_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_b_tp_Chord_change_control, const char_T *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_e_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static uint16_T c3_h_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_id, const char_T *c3_identifier);
static uint16_T c3_i_emlrt_marshallIn(SFc3_SX_HandInstanceStruct *chartInstance,
  const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_e_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_j_emlrt_marshallIn(SFc3_SX_HandInstanceStruct
  *chartInstance, const mxArray *c3_b_setSimStateSideEffectsInfo, const char_T
  *c3_identifier);
static const mxArray *c3_k_emlrt_marshallIn(SFc3_SX_HandInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_updateDataWrittenToVector(SFc3_SX_HandInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex);
static void c3_errorIfDataNotWrittenToFcn(SFc3_SX_HandInstanceStruct
  *chartInstance, uint32_T c3_vectorIndex, uint32_T c3_dataNumber);
static void init_dsm_address_info(SFc3_SX_HandInstanceStruct *chartInstance);
...
static void initialize_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_SX_Hand = 0U;
}
  ...
  *chartInstance)
{
  ...
  if (chartInstance->c3_is_active_c3_SX_Hand == 1U) {
  ...
  *chartInstance)
{
  ...
  c3_h_hoistedGlobal = chartInstance->c3_is_active_c3_SX_Hand;
  ...
  const mxArray *c3_st)
{
  ...
  *c3_vel_for_volO = c3_d_emlrt_marshallIn(chartInstance, sf_mex_dup
  ...
  chartInstance->c3_is_active_c3_SX_Hand = c3_f_emlrt_marshallIn(chartInstance,
    sf_mex_dup(sf_mex_getcell(c3_u, 7)), "is_active_c3_SX_Hand");
  ...
  c3_update_debugger_state_c3_SX_Hand(chartInstance);
...
static void sf_gateway_c3_SX_Hand(SFc3_SX_HandInstanceStruct *chartInstance)
{
  ...
  c3_chord_relO = (uint8_T *)ssGetOutputPortSignal(chartInstance->S, 2);
  c3_id = (uint16_T *)ssGetOutputPortSignal(chartInstance->S, 1);
  c3_set_sim_state_side_effects_c3_SX_Hand(chartInstance);
  ...
  if (chartInstance->c3_is_active_c3_SX_Hand == 0U) {
    _SFD_CC_CALL(CHART_ENTER_ENTRY_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
    chartInstance->c3_is_active_c3_SX_Hand = 1U;
  ...
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG, 0U, chartInstance->c3_sfEvent);
  _SFD_SYMBOL_SCOPE_POP();
  _SFD_CHECK_FOR_STATE_INCONSISTENCY(_SX_HandMachineNumber_,
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  real_T c3_u;
  const mxArray *c3_y = NULL;
  SFc3_SX_HandInstanceStruct *chartInstance;
  chartInstance = (SFc3_SX_HandInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_SX_Hand_get_eml_resolved_functions_info(void)
{
...
void sf_c3_SX_Hand_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_SX_Hand_get_autoinheritance_info(void)
{
  ...
  {
    mxArray *mxChecksum = mxCreateString("a1LH6HpOojelD5w3JR3HpE");
...
mxArray *sf_c3_SX_Hand_third_party_uses_info(void)
{
  mxArray * mxcell3p = mxCreateCellMatrix(1,0);
  return(mxcell3p);
}

mxArray *sf_c3_SX_Hand_updateBuildInfo_args_info(void)
{
  mxArray *mxBIArgs = mxCreateCellMatrix(1,0);
  return mxBIArgs;
}

static const mxArray *sf_get_sim_state_info_c3_SX_Hand(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x10'type','srcId','name','auxInfo'{{M[1],M[75],T\"changeO\",},{M[1],M[20],T\"chord_altO\",},{M[1],M[19],T\"chord_relO\",},{M[1],M[18],T\"id\",},{M[1],M[100],T\"vel_for_volO\",},{M[3],M[99],T\"chord_relL\",},{M[3],M[101],T\"vel_for_volL\",},{M[8],M[0],T\"is_active_c3_SX_Hand\",},{M[8],M[1],T\"is_active_Alterations_control\",},{M[8],M[2],T\"is_active_Chord_change_control\",}}",
  ...
  sf_c3_SX_Hand_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    ...
    chartInstance = (SFc3_SX_HandInstanceStruct *) chartInfo->chartInstance;
    if (ssIsFirstInitCond(S) && fullDebuggerInitialization==1) {
      /* do this only if simulation is starting */
      {
        ...
        init_script_number_translation(_SX_HandMachineNumber_,
          chartInstance->chartNumber,chartInstance->instanceNumber);
        if (chartAlreadyPresent==0) {
          /* this is the first instance */
          sf_debug_set_chart_disable_implicit_casting
            (sfGlobalDebugInstanceStruct,_SX_HandMachineNumber_,
      ...
      sf_debug_reset_current_state_configuration(sfGlobalDebugInstanceStruct,
        _SX_HandMachineNumber_,chartInstance->chartNumber,
        chartInstance->instanceNumber);
    }
  }
}
...
static void sf_opaque_initialize_c3_SX_Hand(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_SX_HandInstanceStruct*) chartInstanceVar)->S,
    0);
  initialize_params_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
  initialize_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_enable_c3_SX_Hand(void *chartInstanceVar)
{
  enable_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_disable_c3_SX_Hand(void *chartInstanceVar)
{
  disable_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
}

static void sf_opaque_gateway_c3_SX_Hand(void *chartInstanceVar)
{
  sf_gateway_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_SX_Hand(SimStruct* S)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_SX_Hand((SFc3_SX_HandInstanceStruct*)
    chartInfo->chartInstance);         /* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_SX_Hand();/* state var info */
...
extern void sf_internal_set_sim_state_c3_SX_Hand(SimStruct* S, const mxArray *st)
{
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
  ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
  mxArray *plhs[1] = { NULL };
  ...
  prhs[2] = (mxArray*) sf_get_sim_state_info_c3_SX_Hand();/* state var info */
  ...
  set_sim_state_c3_SX_Hand((SFc3_SX_HandInstanceStruct*)chartInfo->chartInstance,
    mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_SX_Hand(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_SX_Hand(S);
}

static void sf_opaque_set_sim_state_c3_SX_Hand(SimStruct* S, const mxArray *st)
{
  sf_internal_set_sim_state_c3_SX_Hand(S, st);
}

static void sf_opaque_terminate_c3_SX_Hand(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_SX_HandInstanceStruct*) chartInstanceVar)->S;
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
      unload_SX_Hand_optimization_info();
    }

    finalize_c3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
...
{
  initSimStructsc3_SX_Hand((SFc3_SX_HandInstanceStruct*) chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_SX_Hand(SimStruct *S)
{
  int i;
  ...
  if (sf_machine_global_initializer_called()) {
    ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)(ssGetUserData(S));
    ChartInfoStruct * chartInfo = (ChartInfoStruct *)(crtInfo->instanceInfo);
    initialize_params_c3_SX_Hand((SFc3_SX_HandInstanceStruct*)
      (chartInfo->chartInstance));
  }
}

static void mdlSetWorkWidths_c3_SX_Hand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
    mxArray *infoStruct = load_SX_Hand_optimization_info();
...
static void mdlRTW_c3_SX_Hand(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_SX_Hand(SimStruct *S)
{
  SFc3_SX_HandInstanceStruct *chartInstance;
  ChartRunTimeInfo * crtInfo = (ChartRunTimeInfo *)utMalloc(sizeof
    (ChartRunTimeInfo));
  chartInstance = (SFc3_SX_HandInstanceStruct *)utMalloc(sizeof
    (SFc3_SX_HandInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_SX_HandInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway = sf_opaque_gateway_c3_SX_Hand;
  chartInstance->chartInfo.initializeChart = sf_opaque_initialize_c3_SX_Hand;
  chartInstance->chartInfo.terminateChart = sf_opaque_terminate_c3_SX_Hand;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_SX_Hand;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_SX_Hand;
  chartInstance->chartInfo.getSimState = sf_opaque_get_sim_state_c3_SX_Hand;
  chartInstance->chartInfo.setSimState = sf_opaque_set_sim_state_c3_SX_Hand;
  chartInstance->chartInfo.getSimStateInfo = sf_get_sim_state_info_c3_SX_Hand;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_SX_Hand;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_SX_Hand;
  chartInstance->chartInfo.mdlSetWorkWidths = mdlSetWorkWidths_c3_SX_Hand;
...
void c3_SX_Hand_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_SX_Hand(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_SX_Hand(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_SX_Hand(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_SX_Hand_method_dispatcher.\n"
